 ...
 */
import { CreatePricePackage } from './createPricePackage';


export interface PricePackage {
    numbersColorInPackage?: number;
    priceColorPackage?: number;
    priceColorCopyOverPackage?: number;
    numbersMonoInPackage: number;
    priceMonoPackage: number;
    priceMonoCopyOverPackage: number;
